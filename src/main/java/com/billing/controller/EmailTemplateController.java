...
public class EmailTemplateController {
    ...
    @GetMapping
    @RequirePermission(menu = "EMAIL_TEMPLATES", action = "VIEW")
    ...
    @PostMapping
    @RequirePermission(menu = "EMAIL_TEMPLATES", action = "ADD")
    ...
    @RequirePermission(menu = "EMAIL_TEMPLATES", action = "EDIT")
    ...
    @RequirePermission(menu = "EMAIL_TEMPLATES", action = "DELETE")
